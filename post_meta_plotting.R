...
snp_ref_cc = read.table("/data/davis_lab/golevasb/Projects/PNES_PRS/GWAS/Meta_Analysis_cleaned_ss_absolute_filter_ref_maf/CC/CC_autosome_sumstats_for_meta_analysis_cleaned.txt", stringsAsFactors = FALSE, header=TRUE, comment.char="")
